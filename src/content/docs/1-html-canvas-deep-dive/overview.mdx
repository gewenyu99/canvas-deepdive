...
<Card title="About the Author" icon="document">
  I am Josh Marinacci: manager, developer advocate, software engineer,
  researcher, usability expert, and general miscreant.
  <CardGrid>
    <LinkCard title="Follow me on X" href="https://twitter.com/joshmarinacci" />
    <LinkCard title="Josh On Design" href="https://joshondesign.com" />
  </CardGrid>
</Card>
